...
df_scaffolds = pd.read_csv('/home/ssericksen/matrix_informer/models/compounds/scaffolds/pkis'+matrix+'_gen_scaffids.csv', index_col='molid')
...
print('model,recognized_scaffolds,active_scaffolds,fasr10')
