...
def main():
    ...
    activity_data_csv = 'pkis1.csv'
    distance_data_csv = './compounds/pkis1_jaccard_distmat_ecfp4.csv'
    fps_file = './compounds/pkis1_uniq_ecfp4_1024.fps'
    ...
    try:
        ...
        print('')
        print("usage: ./script.py   number_informers  inf_sel_methods:'clst','prom','prom_glob'  ranking:'se','le','we' ") 
        print('       arg0          arg1              arg2                                       arg3')  
        print('')
        print("running with defaults: n_informers=16, inf_selection='clst', ranking='se' ")
        print('')
        #n_informers = 16	   # any integer
        #inf_selection = 'clst' # also: 'prom_glob', and 'glob'
        #ranking = 'se'	   # also: 'le' and 'we'
        exit(1) 
    ...
    if inf_selection == 'prom':
        df_thresh = pd.read_csv( './thresholds_2sigma/prom_le_thresh.txt', index_col=0, header=None, names=['Activity'], delimiter=" " )
    elif inf_selection == 'clst':
        df_thresh = pd.read_csv( './thresholds_2sigma/clst_le_thresh.txt', index_col=0, header=None, names=['Activity'], delimiter=" " )    
    else:
    ...
    ranked_df.to_csv( 'ranked_df_'+str(n_informers)+'_'+inf_selection+'_'+ranking+'_thresh_v23.csv', index_label='molid' )
    #print ranked_df
